...
<link href="/BoomMall v1/Boommall/Public/css/H-ui.login.css" rel="stylesheet" type="text/css" />
...
<div class="header" style="background:rgba(0,0,0,0.2)">
      ...
      <h1 style="color:white;padding:5px;margin-left:20px">BoomMall 后台管理系统</h1>
...
<div class="loginWraper" >
  <div id="loginform" class="loginBox">
    ...
    <form class="form form-horizontal" action="<?php echo U('login/checkLogin');?>" method="post">
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-8">
          <input id="" name="name" type="text" placeholder="username" class="input-text size-L" >
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
...
<div class="footer">Copyright Boommall 2016.10.01</div>
