...
$(function(){
	...
	//各楼层区域切换
	$("#go1 h2 span").mouseover(function(){
		$(this).addClass("on").siblings().removeClass("on");
		$("#go1_w div").hide().eq($(this).index()).show();

	});
	$("#go2 h2 span").mouseover(function(){
		$(this).addClass("on").siblings().removeClass("on");
		$("#go2_w div").hide().eq($(this).index()).show();

	});
	$("#go3 h2 span").mouseover(function(){
		$(this).addClass("on").siblings().removeClass("on");
		$("#go3_w div").hide().eq($(this).index()).show();
